...
1. Initialize a local copy of the repository:
   ...
   git clone git@github.com:esther-poniatowski/stelion.git
   ```
...
2. Create a virtual environment containing the development dependencies:
   ...
   By default, the environment will be named `stelion`, as specified in the `environment.yml`
